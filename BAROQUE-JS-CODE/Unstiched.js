...
let filterProductsByPrice= function () {
  let filteredProducts = UnstichedProducts.filter((product) => {
...
function showOnFront(id){
  instock.filter(function(o){return o.id===id })
}
...
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/unstiched/chantelle' >CHANTELLE</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/unstiched/loan' >LOAN</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/unstiched/shaal' >SHAAL</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
...
<Link to='/unstiched/login'><img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} /></Link>
  </div>
    </div>
  </div>
...
<Link to='/unstiched/login'><img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} className='hidden'/></Link>
...
<div className="search-showing-area">
      ...
      <div className='center-div'>UNSTICHED</div>
      <div className="allll-2">
      <div className='center-div-2' > <div className='products-bar'> <div className='length-1'>{UnstichedProducts.length}</div> PRODUCTS</div> <div className='new-filter' onClick={toggleSidebar5}><span>Filter</span></div></div>
