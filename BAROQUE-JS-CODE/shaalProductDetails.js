...
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/shaalProductDetails/unstiched' >UNSTICHED</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/shaalProductDetails/chantelle' >CHANTELLE</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/shaalProductDetails/loan' >LOAN</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/shaalProductDetails/shaal' >SHAAL</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
...
<Link to='/shaalProductDetails/login'><img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} /></Link>
  </div>
    </div>
  </div>
</div>
...
<Link to='/shaalProductDetails/login'><img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} className='hidden'/></Link>
...
<div className="quantity-checker">
  <div className="add-minus-2" >
    <button className='add-button-3' onClick={function(){ addToCart(product,TypeSelection[selectedProductId]),toggleSidebar2()}}>ADD TO CART</button>
    <button className='add-button'>BUY NOW</button>
    <div className="buy-now">
