...
function ChantelleProductDetails(){
...
const selectedProduct = chantelle.find((product) => product.id === selectedProductId);
...
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/chantelleProductDetails/unstiched' >UNSTICHED</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/chantelleProductDetails/chantelle' >CHANTELLE</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/chantelleProductDetails/loan' >LOAN</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
<li className={`${sidebarVisible ? 'animation-6' : 'animation-5'}`}><Link to='/chantelleProductDetails/shaal' >SHAAL</Link></li>
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
...
<Link to='/chantelleProductDetails/login'><img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} /></Link>
  </div>
    </div>
  </div>
...
<Link to='/chantelleProductDetails/login'><img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} className='hidden'/></Link>
...
<div className="right-show">
 ...
 <div key={product.id} style={{margin: '19px 6px'}} className='contains-all'>
  ...
  <div className="quantity-checker">
    ...
    <button className='add-button-3' onClick={function(){ addToCart(product) ,toggleSidebar2(),toggleOnFront()}}>ADD TO CART</button>
    </div>
     </div>
...
export default ChantelleProductDetails