  ...
  return (
    <>
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Nunito+Sans:opsz,wght@6..12,400&display=swap" rel="stylesheet" />
      </head>
  ...
  <div className="add-minus-2-5" style={{margin:' 32px 0'}}>
    ...
    <p>{product.quantity}</p>
            ...
            :''
              ...
              <p className='middle adjustments' style={{ fontWeight: 'bold',  marginBottom:'40px'}}>
         {product.pricelogo} {product.price}  {product.priceunit}
              </p>
