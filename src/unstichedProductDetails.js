...
<div className="upper-section">
  ...
  <button id="custom-ham" className={`custom-jango ${sidebarVisible ? 'custom-hid' : ''}`} onClick={toggleSidebar} style={{background: 'transparent', border: '0', margin: '0 30px' }}>
...
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)'}}/>
      ...
      <div className="together-7 hidden-2" >
      <button className="dropbtn hidden-2"  onClick={setmove5}><div className="triangle-down"></div></button>
...
<hr width={'99%'} style={{color:'rgba(0, 0, 0, 0.18)',margin:'20px 0'}}/>
  ...
  <img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} />
  </div>
    </div>
  </div>
</div>
...
<img src="/assests/pngwing.com (35).png" alt=""  width={'20px'} className='hidden' />
...
<div className="search-area">
  ...
  <img src="/assestspngwing.com (36).png" alt=""  width={'20px'}/>
  </div>
